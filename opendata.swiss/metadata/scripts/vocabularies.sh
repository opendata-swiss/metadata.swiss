...
curl -i -X PUT -H "X-API-Key: ${PIVEAU_HUB_API_KEY}" -H "Content-Type: text/turtle" --data @piveau_vocabularies/political-levels.ttl "${HUB_REPO_ENDPOINT}/vocabularies/political-levels"
