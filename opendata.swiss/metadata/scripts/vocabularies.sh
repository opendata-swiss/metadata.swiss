...
curl -i -X PUT -H "X-API-Key: ${PIVEAU_HUB_API_KEY}" -H "Content-Type: application/n-triples" --data @piveau_vocabularies/i14y-legalForm.nt "${HUB_REPO_ENDPOINT}/vocabularies/legal-forms"
