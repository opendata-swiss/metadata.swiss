...
curl -i -X PUT -H "X-API-Key: $API_KEY_HUB" -H "Content-Type: text/turtle" --data @opendata.swiss/metadata/piveau_catalogues/data-so-kt-geocat.ttl "${HUB_REPO_ENDPOINT}/catalogues/so-geocat"
