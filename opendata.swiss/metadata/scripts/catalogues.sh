...
curl -i -X PUT -H "X-API-Key: $API_KEY_HUB" -H "Content-Type: text/turtle" --data @piveau_catalogues/data-stadt-biel.ttl "${HUB_REPO_ENDPOINT}/catalogues/stadt-biel-geocat"
